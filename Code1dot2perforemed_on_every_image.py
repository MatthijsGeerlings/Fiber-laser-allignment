...
for f in os.listdir('.'):
    if f.endswith('.jpg'):
        i = find_fiber_center_code1_dot_2(f)
        j = PIL.Image.open(f)
        fn, fext = os.path.splitext(f)
        j.save('Centers_found_with_code_1_dot_2\{}.jpg'.format(fn))
        i.save('Centers_found_with_code_1_dot_2\{}_core_marked.jpg'.format(fn))