...
'Below the filename of the file that is imported must be entert'
filename = 'fiber_end_2001002_01_copy.jpg'

'Below the fraction of brightesst pixels that must be allowed is enetert'
n=0.001
...
considert 'bright' '''
threshold = pixel_values[int(len(pixel_values)*(1-n))]
...
'Below the same code can be seen, but than written as a function'
